...
export const mobileDevelopment: Array<any> = [
  {
    name: "Java",
  },
  {
...
export const projectContents = [
  {
    title: "NightLight",
    subtitle: "[ 1st place, Safety Category in BCIT Contest]",
    checkout: "https://github.com/PlayerProgramming/Night_LightV2",
    content:
  ...
  {
    title: "Allegro",
    subtitle: "[ 1st place, Creativity Category in BCIT Contest ]",
    checkout: "https://github.com/PlayerProgramming/Allegro",
    content:
